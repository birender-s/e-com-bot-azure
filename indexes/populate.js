...
Promise.all([categories, products]).then((data) => {
    ...
    console.log(JSON.stringify(variantIndex));
    ...
    return Promise.all(Object.keys(indexes).map(index => {
        ...
        return request({
            ...
            console.log(`URL: https://${servicename}.search.windows.net/indexes/${index}/docs/index?api-version=2015-02-28`);

            console.log(`value: ${indexes[index]}`);
